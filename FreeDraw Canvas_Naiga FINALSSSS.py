...
main_frame = tb.Frame(root, padding=8)
main_frame.pack(fill=tk.BOTH, expand=True)

canvas_frame = tb.Frame(main_frame, padding=(10, 10))
...
slider_box = tb.Frame(inner)
slider_box.pack(side=tk.RIGHT, padx=8)

tb.Label(slider_box, text="Brush Size").pack(anchor="e")
brush_slider = tb.Scale(slider_box, from_=1, to=20, orient=tk.HORIZONTAL, command=set_brush_size, length=180)
brush_slider.set(brush_size)
brush_slider.pack(pady=4)

tb.Label(slider_box, text="Eraser Size").pack(anchor="e")
eraser_slider = tb.Scale(slider_box, from_=1, to=50, orient=tk.HORIZONTAL, command=set_eraser_size, length=180)
